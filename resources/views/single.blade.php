    ...
    <div class="row carousel-c">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active item">
                        <img class="d-block w-100 img-fluid" src="{{ asset($single -> image1)}}?auto=yes&bg=777&fg=555&text=First slide"
                            alt="First slide">
                    </div>
                    <div class="carousel-item item">
                        <img class="d-block w-100 img-fluid" src="{{ asset($single -> image2)}}?auto=yes&bg=666&fg=444&text=Second slide"
                            alt="Second slide">
                    </div>
                    <div class="carousel-item item">
                        <img class="d-block w-100 img-fluid" src="{{ asset($single -> image3)}}?auto=yes&bg=555&fg=333&text=Third slide"
                            alt="Third slide">
                    </div>
                </div>
        ...
        <form action="{{ route('make-payment',['id'=>$single -> id,'o_id'=>$single-> user_id]) }}" method="POST">
            ...
            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{ config('services.stripe.key') }}"
                data-amount=" {{ $single -> advance }} " data-name="Book now" data-description="Pay now to book your stay."
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
                        aria-controls="nav-home" aria-selected="true">Property Details</a>
                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false">About owner</a>
                    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab"
                        aria-controls="nav-contact" aria-selected="false">Contact Information</a>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                   <p class="py-5"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, est?</p>
                </div>
